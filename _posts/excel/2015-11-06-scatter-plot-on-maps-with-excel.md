 ...
 - title: Creating Your Chart
   sub-steps:
    ...
    - copy: "Your plot would initially look something like this."
      img: "![Original](https:images.plot.ly/excel/choropleth-maps/original-choropleth-map.png)"
    ...
    - 'Geo layout' dropdown. Select 'USA' for your scope and 'Albers usa' for type."
      img: "![Layout](https:images.plot.ly/excel/choropleth-maps/original-choropleth-map.png)"
