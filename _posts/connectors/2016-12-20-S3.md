...
title: Connect Your Charts and Dashboards to a S3 Database
...
tags: aws
section: Basics
meta_description: Follow these steps to connect to your S3 database
popularity: featured
...
steps:
 ...
 - title: Send a Query to Your Database
   sub-steps:
    ...
    - copy: "Once your file is selected, click *Import File*. If you wish to set your query on a schedule to keep your grid's data updated to the latest entries of your database, visit our [schedule a query tutorial](http://help.plot.ly/database-connectors/schedule-query)."
