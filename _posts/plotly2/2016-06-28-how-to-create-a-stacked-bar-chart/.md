 ...
 - title: Style a Chart
   sub-steps:
    ...
    - copy: "To add a title to your plot, you can type it directly on the title by double-clicking it. The same can be done for the axis labels, and legend."
      img: "![Type directly](../static/images/bar-graph/type-directly-on-title.png)"
      img: "![Type directly](../static/images/bar-graph/axis-labels.png)"
      img: "![Type directly](../static/images/bar-graph/legend-titles.png)"
