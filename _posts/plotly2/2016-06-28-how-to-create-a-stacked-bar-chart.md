...
steps:
 ...
 - title: Create a Chart
   sub-steps:
    ...
    - copy: "Click on GRAPH on the left-hand side to add your Y- axis and X-axis to your stacked bar chart. After selecting ‘Bar chart', you should then select the y and x dropdown, as shown in the figure below, to create the plot."
