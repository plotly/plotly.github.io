...
steps: 
 - title: Getting Started
   sub-steps:
    ...
    - copy: "You can also use the data featured in this tutorial by clicking on 'Open This Data in Plotly' on the left-hand side. It'll open in your [workspace](https://plot.ly/create)."
