...
steps: 
 ...
 - title: Create a Chart
   sub-steps:
    - copy: "After adding your own data, go to GRAPH on the left-hand side, then 'Create'. Choose your 'Chart Type' and select 'Box plot'. Note that this chart is available only on PRO. Click [here](https://plot.ly/products/cloud/) to upgrade"
