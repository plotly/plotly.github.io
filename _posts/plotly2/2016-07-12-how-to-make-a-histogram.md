...
title: How to Make a Histogram in Plotly 2.0
subtitle: How to create a histogram using the Plotly 2.0 data visualization tool
permalink: /make-a-histogram/
imageurl: ../static/images/make-a-histogram/histogram-thumb.png
state: active
tags: statistical
order: 1
meta_description: Learn how to create a histogram online using Plotly 2.0 graphing software.
popularity: featured
carouselimageurl:
...
steps:
 - title: Try an Example
   sub-steps:
    - copy: "A histogram is a graphical representation of the distribution of numerical data. If you'd like to know more about this type of plot, visit [this](http://help.plot.ly/histogram/) page for more information."
 ...
 - title: Create a Chart
   sub-steps:
    ...
    - copy: "We've selected the height as the value for this specific chart. This will create a raw histogram, as seen below. There's still a little work left to finish your plot."
 ...
 - title: Style a Chart
   sub-steps:
    ...
    - copy: "It's also possible to change the bin size (the width of each bin) and the padding between each bar. You can make these adjustments in the 'Traces' section. We want padding between each bar, so we've spaced them by 15%."
      img: "![Bin and bar spacing](../static/images/make-a-histogram/histogram-bin-bar.png)"
    - copy: "The 'Axes' section under STYLE is where you visit if you want to change the axes title(s), range(s), or grid lines behind your plot."
