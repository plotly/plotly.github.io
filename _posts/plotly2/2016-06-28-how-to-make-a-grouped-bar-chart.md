 ...
 - title: Style a Chart
   sub-steps:
    ...
    - copy: "To add a title to your plot, you can type it directly on the title by double-clicking it. The same can be done for the axis labels, and legend."
      img: "![Type directly title](../static/images/bar-graph/group-type-directly.png) ![Type directly axis](../static/images/bar-graph/group-type-axis.png) ![Type directly legend](../static/images/bar-graph/group-legend-label.png)"
