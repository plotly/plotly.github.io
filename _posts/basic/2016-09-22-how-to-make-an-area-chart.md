...
popularity: featured
carouselimageurl:
actioncall: How to create an are chart in Plotly's Chart Studio
...
steps:
 ...
 - title: Create a Chart
   sub-steps:
    ...
    - copy: "Next, select the 'X' and 'Y' values from the dropdown menus. This will create a area trace, as seen below."
 ...
 - title: Style a Chart
   sub-steps:
    ...
    - copy: "To change the color of each individual components of the traces, click on the respective color palettes as seen below. "
