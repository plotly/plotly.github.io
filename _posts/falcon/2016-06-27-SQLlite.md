 ...
 - title: Launch and Connect
   sub-steps:
    - copy: "After launching Falcon, select *SQLite* by clicking on its icon."
      img: "![Connect](https://plotly.github.io/static/images/falcon/sqllite/sqllite.png)"
    - copy: "Enter your path to SQLite file and click *CONNECT*."
      img: "![Credentials](https://plotly.github.io/static/images/falcon/sqllite/credentials.png)"
 - title: Query
   sub-steps:
