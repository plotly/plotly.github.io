...
(Alternative: if you want to stack or overlay your bars, instead of grouping them, just change the **Mode** setting.) | ![How to make a bar chart online](/static/images/bar-graph/style-mode-setting.png) ![Stacked  bar chart online](/static/images/bar-graph/stacked-bar-chart.png)
