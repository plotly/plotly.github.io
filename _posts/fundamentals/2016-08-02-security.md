...
[Chart Studio Security Advisories](http://help.plot.ly/security-advisories/) have their own page.
...
* Bypasses of the "paywall" features (requiring a paid account to access certain features) in Chart Studio online tools
...
* All issues affecting confidentiality of user data or security of user accounts in [Chart Studio On-Premise](https://plot.ly/product/enterprise/).
...
By participating in Chart Studio's Bug Bounty program (the "Program"), you acknowledge that you have read and agree to Chart Studio's [terms of service](https://plot.ly/terms-of-service/) as well as the following:
